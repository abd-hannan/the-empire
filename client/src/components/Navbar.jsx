...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center px-4 sm:ps-12 lg:px-24 xl:px-40 py-4 top-0 z-20 backdrop-blur-xl font-medium'>
      ...
      <img src={assets.logo} className='w-25 sm:w-20' alt="" />
      ...
      <div className={`text-white sm:text-sm ${!sideBarOpen ? 'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10 max-sm:pr-10'} max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary max-sm:text-white max-sm:pt-20 flex sm:items-center gap-15 transition-all`}>
        ...
        <a href="#services" className="sm:hover:text-[#ffa545] font-extrabold">Features</a>
        ...
        <a href="#" className="sm:hover:text-[#ffa545] font-extrabold">About Joben</a>
        <a href="#" className='px-4 py-2 border border-orange-300 text-orange-300 rounded-md hover:bg-orange-300 hover:text-white sm:hidden transition'>
          Login
        </a>
        ...
        <div className="flex items-center gap-2">
          <a href="#" className='px-4 py-2 border border-orange-300 text-orange-300 rounded-md hover:bg-[#cd873d] hover:border-[#cd873d] hover:text-white hidden sm:block transition'>
          Login
          </a>
          <a href="#" className='px-4 py-2 bg-[#ffa545] text-white rounded-md hover:bg-[#cd873d] hidden sm:block transition'>
          Join Now
          </a>
        </div>
