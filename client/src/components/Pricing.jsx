...
const Pricing = () => {
  return (
    <div class="max-w-6xl mx-auto pt-10 pb-36 px-4 text-white">
  
  <div class="flex flex-col justify-between items-center lg:flex-row lg:items-start">
    
    <div class="w-full flex-1 mt-8 p-10 order-2 bg-black/40 backdrop-blur-xl shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none border border-white/20
">
      ...
      <ul class="mb-7 font-medium text-gray-500">
        <li class="flex text-lg mb-2">
          ...
          <span class="ml-3">Get started with <span class="text-white">messaging</span></span>
        </li>
        <li class="flex text-lg mb-2">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
          <span class="ml-3">Flexible <span class="text-white">team meetings</span></span>
        </li>
        <li class="flex text-lg">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
          <span class="ml-3"><span class="text-white">5 TB</span> cloud storage</span>
        </li>
      </ul>
    ...
    <div class="w-full flex-1 p-10 order-1 shadow-xl rounded-3xl bg-black/40 backdrop-blur-xl text-gray-200 sm:w-96 lg:w-full lg:order-2 lg:mt-0 border border-white/20
">
    ...
    <div class="w-full flex-1 mt-8 p-10 order-3 bg-black/25 backdrop-blur-xl shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-3 lg:rounded-l-none border border-white/20
">
      <div class="mb-7 pb-7 flex items-center border-b border-gray-300">
      ...
      <ul class="mb-7 font-medium text-gray-500">
        <li class="flex text-lg mb-2">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
          <span class="ml-3">All features in <span class="text-white">Startup</span></span>
        </li>
        <li class="flex text-lg mb-2">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
          <span class="ml-3">Growth <span class="text-white">oriented</span></span>
        </li>
        <li class="flex text-lg">
          <img src="https://res.cloudinary.com/williamsondesign/check-grey.svg" />
          <span class="ml-3"><span class="text-white">Unlimited</span> cloud storage</span>
        </li>
      </ul>
      <a href="#/" class="flex justify-center items-center bg-orange-300 hover:bg-orange-400 rounded-2xl py-3 px-4 text-center text-white text-xl">
        Pay with Card
